...
![](../assets/node-exporter-example.png)
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": false,
          "expr": "node_filesystem_size_bytes{job=\"$node_exporter_job\", instance=\"$node_exporter_instance\",mountpoint=\"/u01\", device!~\"rootfs\"}\n- node_filesystem_avail_bytes{job=\"$node_exporter_job\", instance=\"$node_exporter_instance\",mountpoint=\"/u01\", device!~\"rootfs\"}",
          "format": "time_series",
          "hide": false,
          "instant": true,
          "intervalFactor": 1,
