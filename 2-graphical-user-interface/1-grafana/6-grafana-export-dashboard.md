...
**Click on the top left on `Export`:**
![](assets/Pasted%20image%2020260407231752.png)

**Click on `Export as code`:**
![](assets/Pasted%20image%2020260407231903.png)

**check the `Export for sharing externally` checkbox the `Copy to clipboard` or `Download file`:**
![](assets/Pasted%20image%2020260407232113.png)
...
```json
{
    ...
    "list": [
      {
        ...
        "definition": "label_values(probe_success{job=\"moodle_blackbox_exporter_job\"},job)",
        "includeAll": true,
        "label": "Blackbox Job",
        "multi": true,
        "name": "blackbox_job",
        ...
        "query": {
          "qryType": 1,
          "query": "label_values(probe_success{job=\"moodle_blackbox_exporter_job\"},job)",
      ...
      },
      {
        ...
        "definition": "label_values(up{job=\"moodle_node_exporter_job\"},job)",
        "includeAll": true,
        ...
        "query": {
          "qryType": 1,
          "query": "label_values(up{job=\"moodle_node_exporter_job\"},job)",
          "refId": "PrometheusVariableQueryEditor-VariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(probe_success{app=\"moodle\", job=\"moodle_blackbox_exporter_job\"},instance)",
        "includeAll": true,
        ...
        "query": {
          "qryType": 1,
          "query": "label_values(probe_success{app=\"moodle\", job=\"moodle_blackbox_exporter_job\"},instance)",
          "refId": "PrometheusVariableQueryEditor-VariableQuery"
        },
        "refresh": 1,
        "regex": "",
      ...
      },
      {
        ...
        "definition": "label_values(up{job=\"moodle_node_exporter_job\"},instance)",
        "includeAll": true,
        ...
        "query": {
          "qryType": 1,
          "query": "label_values(up{job=\"moodle_node_exporter_job\"},instance)",
          "refId": "PrometheusVariableQueryEditor-VariableQuery"
        },
        "refresh": 1,
        "regex": "",
  ...
  "title": "Example: moodle dashboard",
  "uid": "eewyf2sr28sg0e",
  "version": 12,
  "weekStart": ""
}
